        ...
        child: new Column(
          children: <Widget>[
            new Padding(
                ...
                child: new Text('<< Anterior Paguina'),
            ...
            new Padding(
              padding: const EdgeInsets.all(10.0),
              child: new ElevatedButton(
                child: new Text('Siguiente Paguina >>'),
          ...
          children: <Widget>[
            ...
            new Padding(
              ...
              child: new ElevatedButton(
                child: new Text('Siguiente Paguina >>'),
                onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => ForthPage()),
                ),
              ),
            )
          ],
          ...
          children: <Widget>[
            ...
            new Padding(
              ...
              child: new ElevatedButton(
                child: new Text('Siguiente Paguina >>'),
                onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => FifthPage()),
                ),
              ),
            )
          ],
...
class _FifthPage extends State<FifthPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Paguina 5'),
      ),
      body: Center(
        child: ElevatedButton(
          child: const Text('<< Anterior Paguina'),
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: ElevatedButton(
            ...
            // horizontal).
            child: const Text("Siguiente Paguina >>"),
            onPressed: () {
